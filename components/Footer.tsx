        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              {siteConfig.description}. Oferim soluții digitale complete pentru afaceri moderne, 
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-400 transition-colors"
              >
